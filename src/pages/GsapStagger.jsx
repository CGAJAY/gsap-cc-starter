...
const GsapStagger = () => {
    ...
    useGSAP(() => {
        gsap.to(".stagger-box", {
            ...
            ease: "back.inOut",
            stagger: {
                amount: 1, // Stagger the animations by 1 second
                grid: [2, 1], // Define a grid for staggered animations
                axis: "y", // Stagger along the y-axis
                ease: "circ.inOut", // Easing function for staggered animations
                from: "center", // Start staggering from the first element
            },
        });
    }, []);
    ...
    return (
        <main>
            ...
            <p className="mt-5 text-gray-500">
                GSAP stagger is a feature that allows you to apply animations
                with a staggered delay to a group of elements.
            </p>

            <p className="mt-5 text-gray-500">
                By using the stagger feature in GSAP, you can specify the amount
                of time to stagger the animations between each element, as well
                as customize the easing and duration of each individual
                animation. This enables you to create dynamic and visually
                appealing effects, such as staggered fades, rotations,
                movements, and more.
            </p>
